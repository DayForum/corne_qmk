...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GGG] = LAYOUT( \
  //,-----------------------------------------.                ,-----------------------------------------.
      KC_T, KC_TAB, KC_Q, KC_W,  KC_E,  KC_R,                    KC_Y, KC_U,  KC_I,  KC_O, RGB_MOD,RGB_VAI,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      KC_G, KC_LSFT,KC_A, KC_S,  KC_D,  KC_F,                    KC_H, KC_J,  KC_K,  KC_L, RGB_RMOD,RGB_VAD,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      KC_B, KC_LCTL,KC_Z, KC_X,  KC_C,  KC_V,                    KC_N, KC_M, KC_COMM,KC_DOT,KC_DOT,KC_DOT,\
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
